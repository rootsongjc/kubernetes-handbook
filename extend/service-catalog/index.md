...
![Service Catalog 架构](service-catalog-architecture.jpg)
...
![启用一个服务](service-catalog-provision.jpg)
...
![绑定到托管服务](service-catalog-bind.jpg)
...
![映射连接凭证](service-catalog-map.jpg)
