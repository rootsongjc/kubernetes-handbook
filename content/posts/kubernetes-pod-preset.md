...
description: "Preset 就是预设，有时候想要让一批容器在启动的时候就注入一些信息，比如 secret、volume、volume mount 和环境变量，而又不想一个一个的改这些 Pod 的 tmeplate，这时候就可以用到 PodPreset 这个资源对象了。"
bigimg: [{src: "https://res.cloudinary.com/jimmysong/image/upload/images/20151205088.jpg", desc: "什刹海@北京 Dec 5,2015"}]
date: 2017-12-11T10:50:24+08:00
draft: false
---
