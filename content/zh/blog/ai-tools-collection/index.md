...
[chatdoc.com](https://chatdoc.com) 与 ChatPDF 类似，该网站是一个基于ChatGPT技术的文件阅读助手，可以让用户像与人类交互一样与PDF文档进行交互。用户可以上传研究论文、书籍、手册等文件，然后用自然语言提问，获取简洁易懂的回答。回答还会附上直接引用的文件来源，方便用户核实信息的准确性¹⁴。这个网站支持中英文，并且能够识别理解文档中的表格数据。
